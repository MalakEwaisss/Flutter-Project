...
class _SavedLocationsScreenState extends State<SavedLocationsScreen> {
  ...
  void _showAddLocationDialog() {
    ...
    LocationCategory selectedCategory = LocationCategory.other;
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: _buildLocationsList(scrollController),
                  ),
                ],
              ),
            );
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              _buildCategoryFilters(),
              Expanded(
                child: _buildLocationsList(null),
              ),
              Padding(
                padding: const EdgeInsets.all(16),
                child: SizedBox(
  ...
  Widget _buildMap() {
    ...
    return FlutterMap(
      ...
      options: MapOptions(
        center: _filteredLocations.isNotEmpty
