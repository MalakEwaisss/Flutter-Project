...
class _CreateGroupScreenState extends State<CreateGroupScreen> {
  ...
  bool _isPublic = true; // NEW: Track if group is public or private
  ...
  Future<void> _createGroup() async {
    ...
    final newGroup = TripGroup(
      ...
      members: [], // Will be populated by trigger
      isPublic: _isPublic, // NEW: Set visibility
    );
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: _isPublic ? successGreen : accentOrange,
                  ),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text(
                      _isPublic
                          ? '• Anyone can see and join this group\n• Appears in public group listings\n• Great for meeting new travelers'
